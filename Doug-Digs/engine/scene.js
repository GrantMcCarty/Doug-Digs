...
export default class Scene {
    ...
    static deserializeObject(objectDefinition) {
        ...
        gameObject.transform.scaleX = objectDefinition.sx || 1; //Set the x or default to 1. This is already the default, so this is redundant but very clear
        gameObject.transform.scaleY = objectDefinition.sy || 1; //Set the y or default to 1
